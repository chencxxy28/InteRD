...
#change here
write.csv(toast,file="/storage/home/bzs438/chixiang/deconvolution/interd2_new/xinscrna/true_pbar/toastn25m40.csv")
write.csv(interd2,file="/storage/home/bzs438/chixiang/deconvolution/interd2_new/xinscrna/true_pbar/interd2n25m40.csv")
write.csv(interd1,file="/storage/home/bzs438/chixiang/deconvolution/interd2_new/xinscrna/true_pbar/interd1n25m40.csv")
write.csv(scdc_baron,file="/storage/home/bzs438/chixiang/deconvolution/interd2_new/xinscrna/true_pbar/scdc_baronn25m40.csv")
write.csv(scdc_xin,file="/storage/home/bzs438/chixiang/deconvolution/interd2_new/xinscrna/true_pbar/scdc_xinn25m40.csv")
write.csv(scdc_ensemble_mad_all,file="/storage/home/bzs438/chixiang/deconvolution/interd2_new/xinscrna/true_pbar/scdc_ensemble_mad_alln25m40.csv")
write.csv(truep_all,file="/storage/home/bzs438/chixiang/deconvolution/interd2_new/xinscrna/true_pbar/truepn25mr40.csv")
